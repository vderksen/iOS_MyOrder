...
class AllOrdersTableViewController: UITableViewController {
    ...
    // value to hold all orders passed from AddOrderViewController
    var orderCellList = [String]()
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return orderCellList.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "orderCell", for: indexPath)
        cell.textLabel?.text = orderCellList[indexPath.row]
